...
Die Erweiterung **calliope-net/matrix** unterstützt zwei OLED Displays am I²C-Bus gleichzeitig.
Folgende wurden getestet und können beliebig kombiniert werden:
...
* [Grove - OLED Display 0.96 inch](https://wiki.seeedstudio.com/Grove-OLED_Display_0.96inch/) (nur eine feste I²C-Adresse)
...
Auf dem Foto oben ist alles zu sehen.
...
> Zwei [Qwiic Cable - Grove Adapter](https://www.mouser.de/ProductDetail/474-PRT-15109) müssen extra bestellt werden.
